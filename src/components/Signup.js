...
const schema = Yup.object({
    ...
    phone: Yup.string()
        ...
        .matches(/[0-9]/, 'Phone number contain at least 11 characters only number allowed')
        // .min(11, 'minimum 4 characters')
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="row p-4 p-md-0">
                    ...
                    <div className="form-floating mb-3 col-md-6">
                        ...
                        <label for="floatingInput" className='start-25'>First Name</label>
                    ...
                    <div className="form-floating mb-3 col-md-6">
                        ...
                        <label for="floatingPassword" className='start-25'>Last Name</label>
                        {errors?.lastName && <i className="bi bi-x-lg position-absolute top-4 right-5 text-danger"></i>}
                        <p className='text-danger'>{errors?.lastName?.message}</p>
                    </div>
                    <div className="form-floating mb-3 col-md-6">
                        <input type="text" {...register("designation")} className={`form-control position-relative ${errors?.designation && 'border-danger'}`} id="floatingPassword" placeholder="designation" />
                        <label for="floatingPassword" className='start-25'>Designation</label>
                        {errors?.designation && <i className="bi bi-x-lg position-absolute top-4 right-5 text-danger"></i>}
                        <p className='text-danger'>{errors?.designation?.message}</p>
                    </div>
                    <div className="form-floating mb-3 col-md-6">
                        <input type="text" {...register("city")} className={`form-control position-relative ${errors?.city && 'border-danger'}`} id="floatingPassword" placeholder="city" />
                        <label for="floatingPassword" className='start-25'>City</label>
                        {errors?.city && <i className="bi bi-x-lg position-absolute top-4 right-5 text-danger"></i>}
                    ...
                    <div className="form-floating w-100 mb-3">
                        ...
                        <label for="floatingPassword" className='start-25'>Email</label>
                        {errors?.email && <i className="bi bi-x-lg position-absolute top-4 right-5 text-danger"></i>}
                        <p className='text-danger'>{errors?.email?.message}</p>
                    </div>
                    <div className="form-floating w-100 mb-3">
                        <input type="number" {...register("phone")} className={`form-control position-relative ${errors?.phone && 'border-danger'}`} id="floatingPassword" placeholder="phone" autoComplete="off" />
                        <label for="floatingPassword" className='start-25'>Phone No...</label>
                        {errors?.phone && <i className="bi bi-x-lg position-absolute top-4 right-5 text-danger"></i>}
                    ...
                    {/* <div className="form-floating w-100 ps-0">
                        ...
                        <label for="floatingPassword" className='start-25'>Password</label>
                    ...
                    <div className="form-floating w-100 ps-0">
                        ...
                        <label for="floatingPassword" className='start-25'>Confirm Password</label>
                        {errors?.confirmPassword && <i className="bi bi-x-lg position-absolute top-4 right-5 text-danger"></i>}
                        <p className='text-danger'>{errors?.confirmPassword?.message}</p>
                    </div> */}
                    <button type="submit" className="btn btn-primary col-2 ms-3 px-1 py-2">Sign Up</button>
                </div>
            </form>
        </div>
    )
