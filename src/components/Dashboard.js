      ...
      <div className="text-center text-primary w-100 h-50">
        ...
        <div className="container-fluid">
          ...
          <table class="table table-striped table-hover border mb-0">
            ...
            <tbody>
            {(data?.length === 0) ? <tr><td colSpan='8' className='fs-1 py-5'>Employees Not Found!</td></tr> 
            : 
              data?.map((employess, index) => {
                  const {firstName, lastName, email, city, designation, phone, gender} = employess; // object destructuring 
                  return(
                      <tr>
